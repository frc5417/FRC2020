...
public class Constants {
	...
	public static final int m_simulatedMotorPort = 2;

    public static int m_colorMotorPort = 1; //THIS NEEDS TO BE MODIFIED TO FIT WHAT IT IS
    public static String colorTarget = null;
}
