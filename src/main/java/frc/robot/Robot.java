...
public class Robot extends TimedRobot {
  ...
  //  SmartDashboard.putString("Is button pressed?","false");
  }
  ...
  public void autonomousPeriodic() {
    ...
    // for dashboard needs to be edited
  ...
  public void teleopPeriodic() {
    ...
    */
    ...
    // dashboard code to be edited
       SmartDashboard.putBoolean("button?", j.getRawButton(1));
